"use strict";
(self["webpackChunkremote"] = self["webpackChunkremote"] || []).push([["src_ui_TabGroup_jsx"],{
...
/* harmony export */ });
/* harmony import */ var _Tab__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Tab */ "./src/ui/Tab.jsx");
...
const TabGroup = ({
  ...
  }, items.map(item => /*#__PURE__*/React.createElement(_Tab__WEBPACK_IMPORTED_MODULE_0__.Tab, {
    key: path + item.slug,
    item: item,
    path: path
  })));
...
//# sourceMappingURL=src_ui_TabGroup_jsx.js.map